...
export const TUTORIAL_LEVEL: LevelData = {
  ...
  // Replaced open gaps with spike-filled pits: the gap tiles at col 8-9 rows 7-8
  // are now SPIKE so falling in resets the knight.
  topGrid: [
    // Row 0: ceiling
    ...
    // Row 6: ground - bridge gap at 8-9, spike pit at 19
    [S, S, S, S, S, S, S, S, G, G, S, S, S, S, W, W, S, S, S, _, S, S, S, S, S],
    // Row 7: spikes under bridge gap & under pit at 19
